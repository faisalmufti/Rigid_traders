...
export default async function CreateProductPage() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-white to-zinc-500 tracking-tighter uppercase font-heading italic">System Overview <span className="text-blue-500">/ Add Entry</span></h1>
